...
class ViewController: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
 ...
 func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        FormData.shared.selectedItem = indexPath.row
...
//        {
 ...
 func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
    ...
    imagrVIew.frame = CGRect(x: 0, y: 0, width:200, height: 200)
...
//    imagrVIew.clipsToBounds = true
    ...
    //                  pageController.numberOfPages = data.count
            ...
            let strig2 = "https://www.brninfotech.com/tws/ "
            let image1String = "%20"
  ...
  func mediaData()-> [[String:Any]]
    {
       ...
       var urlRequestObj = URLRequest(url: URL(string: "https://www.brninfotech.com/tws/MovieDetails2.php?mediaType=movies")!)
        ...
        let dataTaskObj = URLSession.shared.dataTask(with: urlRequestObj, completionHandler: { (data, respond, error) in
            do{
